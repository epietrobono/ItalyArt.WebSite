                ...
                <>
                    <div className="newsletter row justify-content-center py-3 section-margin">
                        <div className="col d-flex-news text-center">
                            <h2>{NewsletterContainerData.Title}</h2>
                            <p className="newsletter-desc">
                                {NewsletterContainerData.Desc}
                            </p>
                            <SearchForm
                                data={NewsletterContainerData}
                                icon={"email-icon"}
                            ></SearchForm>
                        </div>
                        <div className="img-newsletter">
                            <Image
                                alt={NewsletterContainerData.Image.Alt}
                                src={
                                    process.env.PUBLIC_URL +
                                    NewsletterContainerData.Image.Path
                                }
                            ></Image>
                        </div>
                    </div>
